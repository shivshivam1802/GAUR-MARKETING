    ...
    <footer className="bg-primary text-white">
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <h3 className="text-2xl font-bold font-[family-name:var(--font-poppins)] mb-4">
              {process.env.NEXT_PUBLIC_BUSINESS_NAME} <span className="text-accent"></span>
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span className="text-white/80">hello{process.env.NEXT_PUBLIC_BUSINESS_NAME}.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center text-white/60">
          <p>&copy; {new Date().getFullYear()} {process.env.NEXT_PUBLIC_BUSINESS_NAME}. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
